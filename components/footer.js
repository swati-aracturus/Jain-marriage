  ...
  return (
    <>
      ...
      <section>
        ...
        <div className="w-full flex justify-center text-center items-center py-2 bg-[#080A52] ">
          <div className="w-3/5 py-0  ps:w-full ps:px-4">
            <div className="border-t-[1px] border-b-[1px] border-gray-700 backdrop-blur-sm flex justify-center text-center items-center mt-[5%] ps:mt-[10%] py-2 space-x-2">
              <div className="flex justify-center align-center text-center items-center w-1/3 ">
                <svg
                  width="50" 
                  height="50"
                  viewBox="0 0 50 50"
...
<circle cx="25" cy="25" r="24.5" stroke="#EB2188"/>
<path d="M25 31.5875L32.725 36.25L30.675 27.4625L37.5 21.55L28.5125 20.7875L25 12.5L21.4875 20.7875L12.5 21.55L19.325 27.4625L17.275 36.25L25 31.5875Z" fill="#EB2188"/>
</svg>
