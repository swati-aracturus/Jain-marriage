                ...
                <div className="mx-auto">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="h-11 w-full font-medium bg-cyan-500 hover:bg-sky-500 text-gray-100 text-base rounded-md my-4"
                    >
                      Submit
                    </button>
                    <Toaster
                    ...
                    <div className="text-center text-sm pb-12 text-gray-600">
                      ...
                      <Link href="/">
                        <a className="font-bold  text-sm text-sky-400 no-underline">
                          {" "}
                          Log in
                        </a>
                      </Link>
