    ...
    <>
      ...
      <div className=" w-4/5 flex flex-wrap bg-gray-200 py-4 mx-auto rounded-xl align-center items-center  -translate-y-[10%] pm:translate-y-0  pm:px-4 pm:w-full">
        ...
        <div className="w-1/2 p-[5%] pm:mt-[20%] ps:p-2 ps:w-full">
          ...
          <div className="flex justify-between align-center items-center pt-4">
            <div></div>
...
<path d="M44.4999 14.2567C44.4999 7.85167 39.5299 3.5 33.9999 3.5C28.5283 3.5 23.4999 7.75833 23.4999 14.3267C22.7999 14.7233 22.3333 15.47 22.3333 16.3333V18.6667C22.3333 19.95 23.3833 21 24.6666 21C25.3083 21 25.8333 20.475 25.8333 19.8333V14.2217C25.8333 9.75333 29.2749 5.845 33.7433 5.71667C34.8368 5.68341 35.926 5.87001 36.9461 6.2654C37.9662 6.66079 38.8966 7.25694 39.6821 8.01851C40.4676 8.78009 41.0923 9.69159 41.519 10.699C41.9458 11.7064 42.166 12.7893 42.1666 13.8833V22.1667H33.9999C33.3583 22.1667 32.8333 22.6917 32.8333 23.3333C32.8333 23.975 33.3583 24.5 33.9999 24.5H42.1666C43.4499 24.5 44.4999 23.45 44.4999 22.1667V20.7433C45.1883 20.3817 45.6666 19.67 45.6666 18.83V16.1467C45.6666 15.33 45.1883 14.6183 44.4999 14.2567Z" fill="#EB2188"/>
<path d="M30.4999 16.3333C31.1443 16.3333 31.6666 15.811 31.6666 15.1667C31.6666 14.5223 31.1443 14 30.4999 14C29.8556 14 29.3333 14.5223 29.3333 15.1667C29.3333 15.811 29.8556 16.3333 30.4999 16.3333Z" fill="#EB2188"/>
<path d="M37.4999 16.3333C38.1443 16.3333 38.6666 15.811 38.6666 15.1667C38.6666 14.5223 38.1443 14 37.4999 14C36.8556 14 36.3333 14.5223 36.3333 15.1667C36.3333 15.811 36.8556 16.3333 37.4999 16.3333Z" fill="#EB2188"/>
