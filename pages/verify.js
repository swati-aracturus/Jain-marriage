            ...
            <div className="w-full lg:w-1/3 flex items-center bg-white justify-center py-6 ">
              <div className=" w-2/3 max-w-container ">
                ...
                <div className="mx-auto">
                  <form onClick={(e) => e.preventDefault()} className="grid space-y-6">
                    ...
                    <button
                      onClick={() => otpEvent()}
                      className="h-11 w-full font-medium bg-cyan-400 hover:bg-cyan-500 text-gray-100 text-base rounded-md"
                    >
                      Verify
                    </button>
